...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-science&org_id=1444828305810485&notebook=%2F01-ai-agent-introduction&demo_name=ai-agent&event=VIEW&path=%2F_dbdemos%2Fdata-science%2Fai-agent%2F01-ai-agent-introduction&version=1&user_hash=849103abf30cff95ada66078de7ea959dddec3173bd69b9ad64853593258328d">
# MAGIC
...
# MAGIC %md-sandbox
# MAGIC ## 3.2/ Advanced: MCP Tools for External API Integration
# MAGIC
# MAGIC <img src="https://raw.githubusercontent.com/databricks-demos/dbdemos-resources/main/images/product/ai-agent/mcp-tools.png" style="float: right; margin-left: 10px" width="400px">
# MAGIC
# MAGIC Enhance your agent with external APIs using Databricks Managed MCP Server!
# MAGIC
# MAGIC **What you'll learn:**
# MAGIC - Integrate external APIs (Weather, Distance, Web Search) as MCP tools
# MAGIC - Access Databricks MCP server endpoint: `https://<workspace>/api/2.0/mcp/functions/{catalog}/{schema}`
# MAGIC - Combine internal UC functions with external MCP tools seamlessly
# MAGIC
# MAGIC **Result:** +28% improvement in technical support quality
# MAGIC
# MAGIC Open [03-advanced-capabilities/03.2-mcp-unity-catalog-tools]($./03-advanced-capabilities/03.2-mcp-unity-catalog-tools) to get started.

# COMMAND ----------

# MAGIC %md-sandbox
# MAGIC ## 3.3/ Advanced: Prompt Registry & Cost Optimization
# MAGIC
# MAGIC <img src="https://raw.githubusercontent.com/databricks-demos/dbdemos-resources/main/images/product/ai-agent/prompt-optimization.png" style="float: right; margin-left: 10px" width="400px">
# MAGIC
# MAGIC Systematically manage prompts and optimize costs!
# MAGIC
# MAGIC **What you'll learn:**
# MAGIC - Create Unity Catalog prompt registry with versioning
# MAGIC - Run A/B tests across prompt variants
# MAGIC - Analyze cost vs quality trade-offs
# MAGIC - Implement dynamic prompt selection by context
# MAGIC
# MAGIC **Result:** 30-40% cost savings while maintaining quality
# MAGIC
# MAGIC Open [03-advanced-capabilities/03.3-prompt-registry-management]($./03-advanced-capabilities/03.3-prompt-registry-management) to optimize your prompts.

# COMMAND ----------

# MAGIC %md-sandbox
# MAGIC ## 3.4/ Advanced: Multi-Agent Supervisor System
# MAGIC
# MAGIC <img src="https://raw.githubusercontent.com/databricks-demos/dbdemos-resources/main/images/product/ai-agent/multi-agent.png" style="float: right; margin-left: 10px" width="400px">
# MAGIC
# MAGIC Build specialized agents orchestrated by a supervisor!
# MAGIC
# MAGIC **What you'll learn:**
# MAGIC - Create specialized sub-agents (Billing, Technical, Retention)
# MAGIC - Implement supervisor routing logic
# MAGIC - Coordinate multi-agent workflows
# MAGIC - Measure improvements from specialization
# MAGIC
# MAGIC **Result:** +22% overall quality through domain expertise
# MAGIC
# MAGIC Open [03-advanced-capabilities/03.4-multi-agent-supervisor]($./03-advanced-capabilities/03.4-multi-agent-supervisor) to build your multi-agent system.
...
# MAGIC
# MAGIC Now that our agent is ready (with advanced capabilities!), we can deploy it using Databricks Application.
# MAGIC
